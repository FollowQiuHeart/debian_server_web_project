# Generated by Django 2.0.7 on 2020-03-28 15:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myblog.User', verbose_name='作者')),
            ],
            options={
                'verbose_name': '博客信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myblog.User', verbose_name='用户')),
            ],
            options={
                'verbose_name': '留言',
        ...
        migrations.AddField(
            model_name='blog',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myblog.Category', verbose_name='文章分类'),
        ),
        migrations.AddField(
            model_name='blog',
            name='tag',
            field=models.ManyToManyField(to='myblog.Tagprofile'),
        ),
    ]
